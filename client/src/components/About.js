        ...
        <div className={classes.root}>
          <div className={classes.pictureIntroDoubleColumn}>
            ...
            <Typography variant='body1' className={classes.IntroParagraph} >
              I’m a machine learning engineer based in the San Francisco Bay Area who has worked at a variety of analytics- and machine learning-startups as a web developer. I recently completed Springboard’s <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.springboard.com/workshops/ai-machine-learning-career-track/">machine learning engineering program</Link> and I’m currently a volunteer developer for <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.openmined.org/">OpenMined</Link> where we’re building open source libraries and web applications that combine modern machine learning techniques with privacy-preserving technologies.
            </Typography>
          </div>
          ...
          <div className={classes.columnsContainer}>
            <div className={classes.mainTextColumnLeft}>
              <Typography variant='body1' className={classes.paragraph} >
                I’ve worked at a variety of analytics and machine learning startups, primarily as a front-end and full-stack web developer. Most recently I was at <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://mode.com/">Mode</Link> where I was the lead engineer on a full-stack project to capture screenshots of analytics reports and I conducted a JavaScript workshop for other internal teams. Prior to that I worked at <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.ayasdi.com/">Ayasdi</Link> where I migrated key parts of our web application UI from the Backbone framework to React and Redux and helped implement new features to empower data scientists combining techniques from machine learning and topological data analysis.
              </Typography>
              <Typography variant='body1' className={classes.paragraph} >
