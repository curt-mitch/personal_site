          ...
          <div className={classes.columnsContainer}>
            <div className={classes.mainTextColumnLeft}>
              <Typography variant='body1' className={classes.paragraph} >
                Prior to joining NASA I worked at several analytics and machine learning startups. Most recently I was at <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://mode.com/">Mode Analytics</Link> where I was the lead engineer on a full-stack project to create sharable versions of analytics reports. I also took on several opportunities to present and teach technical topics, including conducting a JavaScript workshop to help Mode’s support engineers provide better assistance to customers. Prior to that I worked at <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.ayasdi.com/">Ayasdi</Link>, where as a frontend developer I helped implement new features to empower data scientists combining techniques from machine learning and topological data analysis.
              </Typography>
              <Typography variant='body1' className={classes.paragraph} >
                I’ve made a few pivots in my career via coding bootcamps and online learning. I picked up my machine learning and data science skills thanks to Springboard’s <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.springboard.com/courses/ai-machine-learning-career-track/">machine learning engineering program</Link>. Several years before that I was in one of the first cohorts of the coding bootcamp <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.hackreactor.com/">Hack Reactor</Link>, which enabled my transition into web development. Prior to Hack Reactor I worked as a data analyst and field engineer for the energy consulting firm <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.dnvgl.com/">DNV GL</Link> for several years. I originally moved to Northern California after completing undergraduate degrees in physics and math from the <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.unt.edu/">University of North Texas</Link>. As a born-and-raised Texan in the Bay Area I like to refer to myself as a NorCal Texpat.🤠
              </Typography>
            </div>
            <div className={classes.mainTextColumnRight}>
              <Typography variant='body1' className={classes.paragraph} >
                Outside of regular working hours I enjoy writing posts for this website, playing with different <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.raspberrypi.org/">Raspberry Pi</Link> projects, as well as learning all I can about cryptography and how to preserve privacy when it comes to the web and machine learning processes. My interest in these topics is what led me to join the <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.openmined.org/">OpenMined</Link> community and contribute code to OpenMined's various open source projects.
              </Typography>
              <Typography variant='body1' className={classes.paragraph} >
                In the non-digital realm my hobbies include reading all categories of books, especially fiction and history (recent favorites include <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.goodreads.com/book/show/49985946-homegoing">Homegoing</Link>, <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.goodreads.com/series/56399-the-expanse">The Expanse Series</Link>, and <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://www.goodreads.com/book/show/76401.Bury_My_Heart_at_Wounded_Knee">Bury My Heart at Wounded Knee</Link>), cooking, meditation, martial arts and personal fitness, and studying languages (previously: German and Spanish, recently: Urdu, continually: Japanese). I also enjoy traveling and my favorite travel experience so far was getting to live in a dojo in rural Japan for a summer while training in Aikido.
              </Typography>
              <Typography variant='body1' className={classes.paragraph} >
