    ...
    return (
      <React.Fragment>
        ...
        <div className={classes.root}>
          ...
          <Typography variant='body1' className={classes.paragraph} >
            This model was trained in a Jupyter notebook with an accessible GPU hosted by Paperspace (the notebook can be found here: <Link color="secondary" underline="hover" target="_blank" rel="noopener noreferrer" href="https://console.paperspace.com/te1qh03hs/notebook/prqqoypka">Encoder-Decoder model for Japanese-to-English Translation</Link>). After 100 epochs that ran for about 30 hours and evaluating the model on test data that took another 12 hours to run, the process was complete.
          </Typography>
          <Typography variant='body1' className={classes.paragraph} >
          ...
          <Typography variant='body1' className={classes.paragraph} >
            Once training and evaluation were complete, I chose to deploy this model through this site. After saving the weights of the model using Tensorflow’s own model saving method and saving the input and target language vectorizers as pickle objects, I built a class within the Django backend that instantiates a model, uses the saved, static weights and vectorizers from the Paperspace training, and returns a predicted English translation.
          </Typography>
          <Typography variant='body1' className={classes.paragraph} >
