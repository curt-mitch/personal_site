...
class MLAlgorithmStatus(models.Model):
  ...
  Attributes:
    status: The status of the algorithm endpoint, one of: testing, staging, production, ab_testing
    active: The boolean flag which points to the currently active status
    created_by: The name of the creator
    created_at: The creation date
    parent_mlalgorithm: The reference to the cooresponding ML algorithm
  """
...
class MLRequest(models.Model):
  ...
  Attributes:
      ...
      parent_mlalgorithm: The reference to the MLAlgorithm used to compute response
  '''
